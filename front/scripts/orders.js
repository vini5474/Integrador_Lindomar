  ...
  const worksheet = XLSX.utils.aoa_to_sheet([
    ...
    ...pedidos.flatMap((pedido) => {
      ...
      return pedido.items.map((item) => [
        ...
        item.preco,
        item.descricao,
        item.imagemProduto.imgagem3,
        item.imagemProduto.imgagem4,
        item.imagemProduto.imgagem5,
        item.imagemProduto.imgagem6,
        item.imagemProduto.imgagem7,
        item.imagemProduto.imgagem8,
        item.imagemProduto.imgagem9,
        item.imagemProduto.imgagem1,
        item.imagemProduto.imgagem2,
        item.imagemProduto.imgagem3,
        item.imagemProduto.imgagem4,
        item.imagemProduto.imgagem5,
        item.imagemProduto.imgagem6,
